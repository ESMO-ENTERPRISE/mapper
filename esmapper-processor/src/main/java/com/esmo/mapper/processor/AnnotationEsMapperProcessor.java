...
import com.esmo.mapper.processor.sourcewriter.JavaClassWriter;
...
public class AnnotationEsMapperProcessor extends AbstractProcessor {
    ...
    protected static String getVersion() {
        try {
            InputStream is = AnnotationEsMapperProcessor.class.getResourceAsStream("/META-INF/maven/com.esmo.mapper.processor/esmapper-processor/pom.properties");
            if (is != null) {
