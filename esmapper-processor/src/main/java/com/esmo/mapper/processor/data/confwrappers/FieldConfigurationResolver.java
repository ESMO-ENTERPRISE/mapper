package com.esmo.mapper.processor.data.confwrappers;
...
import com.esmo.mapper.processor.utils.annotations.data.AnnotationConfigGenerator;
import com.esmo.mapper.processor.utils.annotations.data.AnnotationMapperConfig;
import com.esmo.mapper.processor.utils.annotations.data.fields.AnnotationFieldId;
import com.esmo.mapper.processor.utils.annotations.data.fields.AnnotationFieldIgnore;
import com.esmo.mapper.processor.utils.annotations.data.fields.AnnotationFieldMapping;
import com.esmo.mapper.processor.utils.commons.ObjectUtils;
...
public class FieldConfigurationResolver {
    ...
    public FieldConfigurationResolver(ProcessingEnvironment processingEnv, MapperClassInfo ownerClassInfo, MethodConfigKey forMethodConfig) {
        ...
        this.mapper = ownerClassInfo.getMapperConfig();
    ...
    private static Comparator<ResolvedTransformation> resolvedTransformationComparator = new Comparator<>() {
    ...
    private static Comparator<FieldMappingData> fieldMappingDataComparator = new Comparator<>() {
    ...
    private ConfigErrorReporting findDefautlReport() {
        if (mapper != null && mapper.defaultErrorConfig() != null) return mapper.defaultErrorConfig();
