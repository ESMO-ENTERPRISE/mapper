...
public class AnnotationValues implements SourceGenerator {
	...
	static {
		...
		customResolver.put("\""+ StringEscapeUtils.escapeJava(Context.esMapperConfig) +"\"", "Context.esMapperConfig");
		customResolver.put("\""+ StringEscapeUtils.escapeJava(Context.esMapperContext) +"\"", "Context.esMapperContext");
