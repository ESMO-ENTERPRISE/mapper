...
@MapperConfig(
	fieldIgnore = {
		...
		@FieldIgnore(packages = "com.esmo.mapper.example.ex15.subpackage", value = "g", ignored = IgnoreType.IGNORE_READ),
		@FieldIgnore(packages = "com.esmo.mapper.example.ex15.subpackage", value = "h", ignored = IgnoreType.IGNORE_WRITE)
	}
)
