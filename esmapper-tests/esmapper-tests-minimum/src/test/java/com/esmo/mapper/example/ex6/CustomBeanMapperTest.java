...
public class CustomBeanMapperTest {
    ...
    public void customBeanMapper1Test() throws NoSuchFieldException, IllegalAccessException {
        CustomBeanMapper1 customBeanMapper = MapperUtil.getMapper(CustomBeanMapper1.class);
    ...
    public void customBeanMapper2Test() {
        CustomBeanMapper2 customBeanMapper = MapperUtil.getMapper(CustomBeanMapper2.class);
